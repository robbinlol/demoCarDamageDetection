...
class YOLO(object):
    _defaults = {
        ...
        "model_path": '/home/jhr/projects/car-damage-detective/app/yolox/atten_focal_finetune.pth',
        "classes_path": '/home/jhr/projects/car-damage-detective/app/yolox/cardd_classes.txt',
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape": [640, 640],
    ...
    def detect_image(self, image, crop=False, count=False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font = ImageFont.truetype(font=r'/home/jhr/projects/car-damage-detective/app/yolox/model_data/simhei.ttf',
